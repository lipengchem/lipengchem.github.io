---
title: Materials Studio安装
date: 2019-12-25 14:27:01
permalink: /visualization/MS/001/
categories: 
  - Materials Studio
tags: 
  - Materials Studio
...
创建 OAuth App 时，把 `Homepage URL` 和 `Authorization callback URL` 都设置为当前博客域名即可。
    ...
    [
      'vuepress-plugin-comment',
      {
        ...
        options: {
          ...
          owner: 'lipengchem', // GitHub仓库所有者
          admin: ['lipengchem'], // 对仓库有写权限的人
          distractionFreeMode: false 
        }
      }
    ]
