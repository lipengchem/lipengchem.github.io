...
const htmlModule: VdoingThemeConfig['htmlModules'] = {
  homeSidebarB: `
    ...
    <div style="padding: 0.95rem">
      ...
      <a href="https://game.xugaoyi.com" target="_blank">
        前端学习资源
        <span>
          <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false" x="0px" y="0px" viewBox="0 0 100 100" width="15" height="15" class="icon outbound">
            <path fill="currentColor" d="M18.8,85.1h56c2.2,0,4-1.8,4-4v-32h-8v28h-48v-48h28v-8h-32c-2.2,0-4,1.8-4,4v56C14.8,83.3,16.6,85.1,18.8,85.1z"></path>
